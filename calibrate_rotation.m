...
AssertOpenGL;
%%%%%%%%%%%%%%%%%%%%%%%%%%%% CAMERA KAPTURE
test_location = 'BIC'; %options: SSS, BIC, MRRC
switch test_location
    ...
    case 'BIC'
        ...
        DISC_SIZE = 40;%40 %40 for SSS camera, 32 for BIC scanner camera
...
[win, rect] = Screen('OpenWindow', screenNumber, 0);% 0); %, [0 0 800 450]);
